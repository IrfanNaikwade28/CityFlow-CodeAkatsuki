...
import {
  ...
  Phone, Mail, MapPin, Hash, LogOut,
} from 'lucide-react-native';

const INFO_ROWS = [
  { label: 'Citizen ID', key: 'displayId', Icon: Hash  },
...
const styles = StyleSheet.create({
  ...
  avatarBox: { width: 64, height: 64, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.25)', borderWidth: 2, borderColor: 'rgba(255,255,255,0.4)' },
  ...
  eyeBtn: { padding: 4 },
  updateBtn: { marginTop: 20, borderRadius: 14, paddingVertical: 14, alignItems: 'center', backgroundColor: '#2563eb' },
